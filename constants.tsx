...
export const NAVIGATION_ITEMS = [
  ...
  {
    view: View.SYSTEM_HARDENER,
    label: 'System Hardener',
  ...
  {
    view: View.AEGIS_HARDENER,
    label: 'Aegis Hardener',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15a3 3 0 100-6 3 3 0 000 6z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 1v2m5.66 2.34l-1.42 1.42M19 12h-2m-2.34 5.66l-1.42-1.42M12 19v2m-5.66-2.34l1.42-1.42M5 12h2m2.34-5.66l1.42 1.42" /></svg>,
    theme: {
      hover: 'group-hover:text-yellow-300',
    },
  },
  {
    view: View.SUBNET_MESSENGER,
    label: 'Subnet Messenger',
  ...
  },
  {
    ...
    label: 'Admin Console',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><polyline points="4 17 10 11 4 5"></polyline><line x1="12" y1="19" x2="20" y2="19"></line></svg>,
    theme: {
      hover: 'group-hover:text-cyan-300',
    },
  },
  {
    view: View.DATA_LOSS_PREVENTION,
    label: 'Data Loss Prevention',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path strokeLinecap="round" strokeLinejoin="round" d="M14.5 11.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14v3" /></svg>,
    theme: {
      hover: 'group-hover:text-amber-300',
    },
  },
