    ...
    return (
        <div className="p-6 h-full flex flex-col items-center justify-center gap-6">
            ...
            <div className="relative w-48 h-48 flex items-center justify-center">
                 <div
                    className="absolute w-full h-full rounded-full bg-fuchsia-500/20 transition-all duration-700"
                    style={{ transform: `scale(${1 + micVolume / 180})`, filter: `blur(${micVolume / 20}px)`, opacity: 0.8 }}
                />
                <div
                    className="absolute w-full h-full rounded-full bg-fuchsia-500/20 transition-all duration-500"
                    style={{ transform: `scale(${1 + micVolume / 280})`, filter: `blur(${micVolume / 40}px)`, opacity: 0.9 }}
                />
                <div
                    className="absolute w-full h-full rounded-full bg-fuchsia-500/20 transition-all duration-300"
                    style={{ transform: `scale(${1 + micVolume / 450})` }}
                />
